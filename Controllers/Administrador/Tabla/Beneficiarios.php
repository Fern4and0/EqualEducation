...
<body onload="googleTranslateElementInit()">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#" style="padding: 10;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'Solicitudes.php' ? 'active' : ''; ?>" href="../mecanicas/Solicitudes.php"><i class="fas fa-envelope"></i> Solicitudes</a>
                </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a id="confirmDeleteBtn" href="../mecanicas/delete_user.php" class="btn btn-danger">Eliminar</a>
                </div>
            </div>
        </div>
    </div>
